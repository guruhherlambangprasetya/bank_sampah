...
<body onload="print()">
	...
	<table class="table table-bordered" style="margin-bottom: 10px" id="">
            ...
            <td><?php echo "Rp. ". $pembelian->total; $total_tabungan = $total_tabungan+$pembelian->total; ?></td>
            ...
            ?>
            <tr>
                <td colspan="6">Total Tabungan</td>
                <td colspan="2"><b><?php echo "Rp. ". number_format($total_tabungan) ?></b></td>
            </tr>
            </tbody>
        </table>
    ...
    <table class="table table-bordered">
        ...
        <tr>
                ...
                <td ><b><?php echo "Rp. ". number_format($total_penarikan) ?></b></td>
            </tr>
         <tr>
         		<td colspan="3">Total Tabungan saat ini</td>
         		<td><b><?php echo "Rp. ". number_format($total_tabungan-$total_penarikan);?></b></td>
         </tr>
    </table>
</div>
