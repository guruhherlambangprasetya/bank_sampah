<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <?php } ?>
        ...
        <li><a href="app/Tentang_Aplikasi"><i class="fa fa-circle-o text-red"></i> <span>Tentang Aplikasi</span></a></li>
        <li><a href="app/bantuan"><i class="fa fa-circle-o text-aqua"></i> <span>Bantuan</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>